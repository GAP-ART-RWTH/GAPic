...
\coordinate (V2) at (-0.04499999882434279 , 0.7000000005384689);
\coordinate (V3) at (0.699999999461531 , 0.);
\coordinate (V4) at (1.794896514920806e-09 , 1.);
\coordinate (V5) at (-0.001012503944756083 , -0.7067499996109562);
\coordinate (V6) at (-1. , 3.589793029841612e-09);
\coordinate (V7) at (-5.384689322717813e-09 , -1.);
\coordinate (V8) at (-0.7067500006313547 , -0.04499999740637455);
\draw[edge] (V1) -- node[edgeLabel] {$[ 1, 3 ]$} (V3);
\draw[edge] (V1) -- node[edgeLabel] {$[ 1, 4 ]$} (V4);
\draw[edge] (V1) -- node[edgeLabel] {$[ 1, 7 ]$} (V7);
\draw[edge] (V2) -- node[edgeLabel] {$[ 2, 3 ]$} (V3);
\draw[edge] (V2) -- node[edgeLabel] {$[ 2, 4 ]$} (V4);
\draw[edge] (V2) -- node[edgeLabel] {$[ 2, 8 ]$} (V8);
\draw[edge] (V3) -- node[edgeLabel] {$[ 3, 1 ]$} (V1);
\draw[edge] (V3) -- node[edgeLabel] {$[ 3, 2 ]$} (V2);
\draw[edge] (V3) -- node[edgeLabel] {$[ 3, 5 ]$} (V5);
\draw[edge] (V4) -- node[edgeLabel] {$[ 4, 1 ]$} (V1);
\draw[edge] (V4) -- node[edgeLabel] {$[ 4, 2 ]$} (V2);
\draw[edge] (V4) -- node[edgeLabel] {$[ 4, 6 ]$} (V6);
\draw[edge] (V5) -- node[edgeLabel] {$[ 5, 3 ]$} (V3);
\draw[edge] (V5) -- node[edgeLabel] {$[ 5, 7 ]$} (V7);
\draw[edge] (V5) -- node[edgeLabel] {$[ 5, 8 ]$} (V8);
\draw[edge] (V6) -- node[edgeLabel] {$[ 6, 4 ]$} (V4);
\draw[edge] (V6) -- node[edgeLabel] {$[ 6, 7 ]$} (V7);
\draw[edge] (V6) -- node[edgeLabel] {$[ 6, 8 ]$} (V8);
\draw[edge] (V7) -- node[edgeLabel] {$[ 7, 1 ]$} (V1);
\draw[edge] (V7) -- node[edgeLabel] {$[ 7, 5 ]$} (V5);
\draw[edge] (V7) -- node[edgeLabel] {$[ 7, 6 ]$} (V6);
\draw[edge] (V8) -- node[edgeLabel] {$[ 8, 2 ]$} (V2);
\draw[edge] (V8) -- node[edgeLabel] {$[ 8, 5 ]$} (V5);
\draw[edge] (V8) -- node[edgeLabel] {$[ 8, 6 ]$} (V6);
% Draw the faces
